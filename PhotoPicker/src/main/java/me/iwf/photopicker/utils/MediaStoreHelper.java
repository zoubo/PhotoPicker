...
public class MediaStoreHelper {
  ...
  public static void getVideoDirs(FragmentActivity activity, Bundle args, PhotosResultCallback resultCallback) {
    activity.getSupportLoaderManager()
  ...
  private static class VideoDirLoaderCallbacks implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public VideoDirLoaderCallbacks(Context context, PhotosResultCallback resultCallback) {
      this.context = context;
      this.resultCallback = resultCallback;
    }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
      ...
      List<PhotoDirectory> directories = new ArrayList<>();
      PhotoDirectory photoDirectoryAll = new PhotoDirectory();
      photoDirectoryAll.setName(context.getString(R.string.__picker_all_video));
      photoDirectoryAll.setId("ALL");
